      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Comienza tu camino en Chess Bets Academy
          </p>
        </div>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-700 bg-zinc-800/50 px-4 py-2.5 text-sm text-zinc-300 transition-colors hover:bg-zinc-800"
        >
