  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mb-2 text-xl font-bold text-zinc-100">Error de autenticación</h1>
        <p className="mb-6 text-sm text-zinc-500">{error.message || 'No se pudo cargar esta página.'}</p>
        <button
          onClick={reset}
